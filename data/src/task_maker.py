...
ann0["segmentation"] = "http://localhost:3000/examples?filename=masks/13.png"
ann1 = {}
ann1["category"] = "wall"
ann1["segmentation"] = "http://localhost:3000/examples?filename=masks/1.png"
task0["annotations"] = [ann0, ann1]

task1 = {}
task1["task_id"] = "00000001"
task1["image_url"] = "http://localhost:3000/examples?filename=images/1.jpg"
task1["segmentation"] = "http://localhost:3000/examples?filename=masks/13.png"
